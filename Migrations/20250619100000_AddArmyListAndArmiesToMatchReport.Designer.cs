...
namespace WarApi.Migrations
{
    ...
    [Migration("20250619100000_AddArmyListAndArmiesToMatchReport")]
    partial class AddArmyListAndArmiesToMatchReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatchReportNamespace.MatchReport", b =>
                {
                    ...
                    b.Property<string>("ArmyA")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ArmyB")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WarApi.Models.ArmyList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WarApi.Models.ArmyList", b =>
                {
                    b.HasOne("WarApi.Models.Player", "Player")
                        .WithMany()
